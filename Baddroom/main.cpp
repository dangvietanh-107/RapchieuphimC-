...
int main(int argc, char** argv) {
	...
	printf("Nhấn m đóng mở cửa tủ \n");
	printf("Nhấn 1 bật đèn \n");
	printf("Nhấn 0 tắt đèn \n");
	printf("Nhấn q, e phóng to thu nhỏ \n");
	printf("Nhấn w,s,a,d di chuyển lên xuống trái phải \n");
